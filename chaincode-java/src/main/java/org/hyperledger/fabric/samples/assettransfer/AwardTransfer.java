...
public class AwardTransfer implements ContractInterface {
    ...
    public void init(final Context context) throws JsonProcessingException {
        ...
        create(context, "education1", "title1", 1L, "publisher1", LocalDateTime.now(), "rank1");
        create(context, "education2", "title2", 2L, "publisher2", LocalDateTime.now(), "rank2");
        create(context, "education3", "title3", 3L, "publisher3", LocalDateTime.now(), "rank3");
        create(context, "education4", "title4", 4L, "publisher4", LocalDateTime.now(), "rank4");
        create(context, "education5", "title5", 5L, "publisher5", LocalDateTime.now(), "rank5");
        create(context, "education6", "title6", 6L, "publisher6", LocalDateTime.now(), "rank6");
    }
